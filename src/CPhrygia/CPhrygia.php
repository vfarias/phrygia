...
class CPhrygia implements ISingleton {
 ...
 // Take current url and divide it in controller, method and parameters
  ...
  public function ThemeEngineRender() {
    ...
    $themePath  = PHRYGIA_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = PHRYGIA_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $phr = &$this;
    // First the default Phrygia themes/functions.php
...
public function CreateUrl($urlOrController=null, $method=null, $arguments=null) {
  ...
  /**
   * Draw HTML for a menu defined in $phr->config['menus'].
   *
